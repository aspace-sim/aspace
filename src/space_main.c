...
void
addConsole(char *console_name, dbref console_dbref)
{
...
void
lookup_space(const char *name, dbref *space)
{
  dbref thing;
  int i = 0;
                         ...
                         */
{
  ...
  if (!Wizard(executor) && !has_power_by_name(executor, "SDB-OK", NOTYPE) &&
      !has_power_by_name(executor, "SDB-READ", NOTYPE)) {
  ...
  case 'd': /* do */
    ...
    case 0:
      safe_str(unparse_integer(debug_space(n)), buff, bp);
      break;
    case 1:
      safe_str(
        unparse_integer(do_set_main_reactor(parse_number(args[3]), enactor)),
        buff, bp);
      break;
    case 2:
      safe_str(
        unparse_integer(do_set_aux_reactor(parse_number(args[3]), enactor)),
        buff, bp);
      break;
    case 3:
      safe_str(unparse_integer(do_set_battery(parse_number(args[3]), enactor)),
               buff, bp);
      break;
    case 4:
      safe_str(unparse_integer(do_set_course(parse_number(args[3]),
                                             parse_number(args[4]),
                                             parse_number(args[5]), enactor)),
               buff, bp);
      break;
    case 5:
      safe_str(unparse_integer(do_set_speed(parse_number(args[3]), enactor)),
               buff, bp);
      break;
    case 6:
      safe_str(unparse_integer(
                 do_set_eng_alloc(parse_number(args[3]), parse_number(args[4]),
                                  parse_number(args[5]), enactor)),
               buff, bp);
      break;
    case 7:
      safe_str(unparse_integer(
                 do_set_helm_alloc(parse_number(args[3]), parse_number(args[4]),
                                   parse_number(args[5]), enactor)),
               buff, bp);
      break;
    case 8:
      safe_str(unparse_integer(do_set_shield_alloc(
                 parse_number(args[3]), parse_number(args[4]),
                 parse_number(args[5]), parse_number(args[6]),
                 parse_number(args[7]), parse_number(args[8]), enactor)),
               buff, bp);
      break;
    case 9:
      safe_str(unparse_integer(do_set_tactical_alloc(
                 parse_number(args[3]), parse_number(args[4]),
                 parse_number(args[5]), enactor)),
               buff, bp);
      break;
    case 10:
      safe_str(unparse_integer(do_set_sensor_alloc(
                 parse_number(args[3]), parse_number(args[4]), enactor)),
               buff, bp);
      break;
    case 11:
      safe_str(unparse_integer(do_set_operations_alloc(
                 parse_number(args[3]), parse_number(args[4]),
                 parse_number(args[5]), enactor)),
               buff, bp);
      break;
    case 12:
      safe_str(unparse_integer(do_set_active(enactor)), buff, bp);
      break;
    case 13:
      safe_str(unparse_integer(do_set_inactive(enactor)), buff, bp);
      break;
    case 14:
      safe_str(unparse_integer(do_set_dock(parse_integer(args[3]), enactor)),
               buff, bp);
      break;
    case 15:
      safe_str(unparse_integer(do_set_undock(enactor)), buff, bp);
      break;
    case 16:
      safe_str(unparse_integer(do_set_shield(parse_integer(args[3]),
                                             parse_integer(args[4]), enactor)),
               buff, bp);
      break;
    case 17:
      safe_str(unparse_integer(do_set_trans(parse_integer(args[3]), enactor)),
               buff, bp);
      break;
    case 18:
      safe_str(unparse_integer(do_set_weapon(
                 parse_integer(args[3]), parse_integer(args[4]),
                 parse_integer(args[5]), parse_integer(args[6]), enactor)),
               buff, bp);
      break;
    case 19:
      safe_str(unparse_integer(do_set_trans_locked(
                 parse_integer(args[3]), parse_integer(args[4]), enactor)),
               buff, bp);
      break;
    case 20:
      safe_str(
        unparse_integer(do_set_autopilot(parse_integer(args[3]), enactor)),
        buff, bp);
      break;
    case 21:
      safe_str(unparse_integer(do_set_trans_unlocked(enactor)), buff, bp);
      break;
    case 22:
      safe_str(unparse_integer(do_lock_weapon(
                 parse_integer(args[3]), parse_integer(args[4]),
                 parse_integer(args[5]), parse_integer(args[6]), enactor)),
               buff, bp);
      break;
    case 23:
      safe_str(unparse_integer(do_unlock_weapon(
                 parse_integer(args[3]), parse_integer(args[4]),
                 parse_integer(args[5]), enactor)),
               buff, bp);
      break;
    case 24:
      safe_str(
        unparse_integer(do_set_docking_doors(parse_integer(args[3]), enactor)),
        buff, bp);
      break;
    case 25:
      safe_str(
        unparse_integer(do_set_landing_doors(parse_integer(args[3]), enactor)),
        buff, bp);
      break;
    case 26:
      safe_str(unparse_integer(do_set_lrs(parse_integer(args[3]), enactor)),
               buff, bp);
      break;
    case 27:
      safe_str(unparse_integer(
                 do_set_ftr_alloc(parse_number(args[3]), parse_number(args[4]),
                                  parse_number(args[5]), enactor)),
               buff, bp);
      break;
    case 28:
      safe_str(unparse_integer(do_set_evade(parse_integer(args[3]), enactor)),
               buff, bp);
      break;
    case 29:
      safe_str(unparse_integer(do_set_srs(parse_integer(args[3]), enactor)),
               buff, bp);
      break;
    case 30:
      safe_str(unparse_integer(do_set_ew(parse_integer(args[3]), enactor)),
               buff, bp);
      break;
    case 31:
      safe_str(unparse_integer(do_set_tract(parse_integer(args[3]), enactor)),
               buff, bp);
      break;
    case 32:
      safe_str(unparse_integer(do_set_cloak(parse_integer(args[3]), enactor)),
               buff, bp);
      break;
    case 33:
      safe_str(unparse_integer(do_set_eta(parse_number(args[3]), enactor)),
               buff, bp);
      break;
    case 34:
      safe_str(unparse_integer(do_set_land(parse_integer(args[3]), enactor)),
               buff, bp);
      break;
    case 35:
      safe_str(unparse_integer(do_set_launch(enactor)), buff, bp);
      break;
    case 36:
      safe_str(
        unparse_integer(do_set_enter_wormhole(parse_integer(args[3]), enactor)),
        buff, bp);
      break;
    case 37:
      safe_str(unparse_integer(do_set_coords_manual(
                 parse_number(args[3]), parse_number(args[4]),
                 parse_number(args[5]), enactor)),
               buff, bp);
      break;
    case 38:
      safe_str(unparse_integer(do_set_coords_reset(enactor)), buff, bp);
      break;
    case 39:
      safe_str(unparse_integer(do_set_fix_damage(
                 args[3], args[4], parse_integer(args[5]), args[6], enactor)),
               buff, bp);
      break;
    case 40:
      safe_str(
        unparse_integer(do_set_intercept(parse_integer(args[3]), enactor)),
        buff, bp);
      break;
    case 41:
      safe_str(unparse_integer(do_set_coords_layin(
                 parse_number(args[3]), parse_number(args[4]),
                 parse_number(args[5]), enactor)),
               buff, bp);
      break;
    case 42:
      safe_str(
        unparse_integer(do_set_shield_freq(parse_number(args[3]), enactor)),
        buff, bp);
      break;
    case 43:
      safe_str(
        unparse_integer(do_set_cloak_freq(parse_number(args[3]), enactor)),
        buff, bp);
      break;
    case 44:
      safe_str(
        unparse_integer(do_set_beam_freq(parse_number(args[3]), enactor)), buff,
        bp);
      break;
    case 45:
      safe_str(
        unparse_integer(do_set_missile_freq(parse_number(args[3]), enactor)),
        buff, bp);
      break;
    case 46:
      safe_str(
        unparse_integer(do_set_trans_freq(parse_number(args[3]), enactor)),
        buff, bp);
      break;
    case 47:
      safe_str(
        unparse_integer(do_set_tract_freq(parse_number(args[3]), enactor)),
        buff, bp);
      break;
    case 48:
      safe_str(
        unparse_integer(do_set_tract_locked(parse_integer(args[3]), enactor)),
        buff, bp);
      break;
    case 49:
      safe_str(unparse_integer(do_set_tract_unlocked(enactor)), buff, bp);
      break;
    case 50:
      safe_str(unparse_integer(do_set_refuel(args[3], args[4],
                                             parse_number(args[5]), enactor)),
               buff, bp);
      break;
    case 51:
      safe_str(
        unparse_integer(do_set_defuel(args[3], parse_number(args[4]), enactor)),
        buff, bp);
      break;
    case 52:
      safe_str(unparse_integer(do_set_fire(
                 parse_integer(args[3]), parse_integer(args[4]),
                 parse_integer(args[5]), parse_integer(args[6]), enactor)),
               buff, bp);
      break;
    case 53:
      safe_str(unparse_integer(do_set_yaw(parse_number(args[3]), enactor)),
               buff, bp);
      break;
    case 54:
      safe_str(unparse_integer(do_set_pitch(parse_number(args[3]), enactor)),
               buff, bp);
      break;
    case 55:
      safe_str(unparse_integer(do_set_roll(parse_number(args[3]), enactor)),
               buff, bp);
      break;
    case 56:
      safe_str(unparse_integer(do_set_coords_engage(enactor)), buff, bp);
      break;
    case 58:
      safe_str(
        unparse_integer(do_set_parallel(parse_integer(args[3]), enactor)), buff,
        bp);
      break;
    case 59:
      safe_str(
        unparse_integer(do_set_iff_frequency(parse_number(args[3]), enactor)),
        buff, bp);
      break;
  ...
  case 'e': /* empty */
    x = get_empty_sdb();
    if (x == VACANCY_FAIL) {
      safe_str("#-1 NO EMPTY SDB NUMBER", buff, bp);
      return;
    }
    safe_str(unparse_integer(x), buff, bp);
    break;
  case 'f': /* function */
    switch (args[2][0]) {
    case 'i': /*Iff friendly check */
      ...
      if (!GoodSDB(n)) {
        safe_str("#-1 SDB 1 OUT OF RANGE", buff, bp);
        return;
      }
      if (!GoodSDB(x)) {
        safe_str("#-1 SDB 2 OUT OF RANGE", buff, bp);
        return;
      }
      safe_str(unparse_integer(sdb2friendly(n, x)), buff, bp);
      break;
    case 'a': /* angular velocity */
      ...
      safe_str(unparse_number(sdb2angular(n, x)), buff, bp);
      break;
    case 'b': /* bearing */
      n = parse_integer(args[1]);
      if (!GoodSDB(n)) {
      ...
      safe_chr(' ', buff, bp);
      safe_str(unparse_number(sdb2elevation(n, x)), buff, bp);
      break;
    case 'd': /* dump */
    ...
    case 'f': /* fix */
      ...
      safe_str(unparse_integer(repair_everything()), buff, bp);
      break;
    case 'r': /* range */
      if (is_dbref(args[1]))
        n = dbref2sdb(parse_dbref(args[1]));
      ...
      safe_str(unparse_range(sdb2range(n, x)), buff, bp);
      break;
    case 's': /* shield */
      if (is_dbref(args[1]))
        n = dbref2sdb(parse_dbref(args[1]));
      ...
      if (sdb[n].shield.exist && sdb2dissipation(n, s)) {
        safe_str(tprintf("%s Up", unparse_shield(s)), buff, bp);
        return;
      }
      safe_str(tprintf("%s Dn", unparse_shield(s)), buff, bp);
      break;
    case 't': /* transporter */
      if (is_dbref(args[1]))
        n = dbref2sdb(parse_dbref(args[1]));
        ...
        n = parse_integer(args[1]);
      if (!GoodSDB(n)) {
        safe_str("#-2 SDB 1 OUT OF RANGE", buff, bp);
        return;
      }
      if (!sdb[n].trans.exist) {
        safe_str("#-3 TRANSPORTER NONEXISTANT", buff, bp);
        return;
      }
      if (!sdb[n].trans.damage) {
        safe_str("#-4 TRANSPORTER DAMAGED", buff, bp);
        return;
      }
      if (!sdb[n].trans.active) {
        safe_str("#-5 TRANSPORTER OFFLINE", buff, bp);
        return;
      }
      s = sdb[n].trans.s_lock;
      if (!GoodSDB(s)) {
        safe_str("#-6 TRANSPORTER SOURCE UNLOCKED", buff, bp);
        return;
      }
      x = sdb[n].trans.d_lock;
      if (!GoodSDB(x)) {
        safe_str("#-7 TRANSPORTER DEST UNLOCKED", buff, bp);
        return;
      }
      if (n != s)
        if (sdb[n].slist.lev[sdb2slist(n, s)] < 0.5) {
          safe_str("#-8 INSUFFICIENT SOURCE RESOLUTION", buff, bp);
          return;
        }
      if (n != x)
        if (sdb[n].slist.lev[sdb2slist(n, x)] < 0.5) {
          safe_str("#-9 INSUFFICIENT DEST RESOLUTION", buff, bp);
          return;
        }
      if (n != s)
        if (sdb2range(n, s) > MAX_TRANSPORTER_DISTANCE * sdb[n].tech.sensors) {
          safe_str("#-10 SOURCE OUT OF RANGE", buff, bp);
          return;
        }
      if (n != x)
        if (sdb2range(n, x) > MAX_TRANSPORTER_DISTANCE * sdb[n].tech.sensors) {
          safe_str("#-11 DEST OUT OF RANGE", buff, bp);
          return;
        }
      if (sdb[n].power.total * sdb[n].alloc.transporters < sdb[n].trans.cost) {
        safe_str("#-12 INSUFFICIENT POWER", buff, bp);
        return;
      }
      if (s != n) {
        ...
        if (sdb[n].shield.exist)
          if (fabs(sdb[n].shield.freq - sdb[n].trans.freq) > 0.005)
            if (sdb2dissipation(n, sdb2shield(n, x)) != 0.0) {
              safe_str("#-15 DEST FACING SHIELD UP", buff, bp);
              return;
            }
        if (sdb[x].shield.exist)
          if (fabs(sdb[n].shield.freq - sdb[x].trans.freq) > 0.005)
            if (sdb2dissipation(x, sdb2shield(x, n)) != 0.0) {
              safe_str("#-16 DEST CONTACT SHIELD UP", buff, bp);
              return;
            }
      }
      safe_str(tprintf("%s %s %s", unparse_dbref(sdb[n].object),
                       unparse_dbref(sdb[s].object),
                       unparse_dbref(sdb[x].object)),
               buff, bp);
      break;
    default:
      safe_str("#-1 NO SUCH SDB FUNCTION", buff, bp);
      break;
    }
    break;
  case 'g': /* get */
    ...
    do_space_db_get(x, args[2], args[3], args[4], args[5], buff, bp);
    break;
  case 'i': /* iterate */
    safe_str(unparse_integer(do_space_db_iterate()), buff, bp);
    break;
  case 'p': /* put */
    if (is_dbref(args[1]))
      x = dbref2sdb(parse_dbref(args[1]));
    ...
    do_space_db_put(x, args[2], args[3], args[4], args[5], args[6], buff, bp);
    break;
  case 'r': /* read */
    ...
    if (!SpaceObj(ship) || !GoodObject(ship)) {
      safe_str("#-1 INVALID SPACE OBJECT", buff, bp);
      return;
    }
    safe_str(unparse_integer(do_space_db_read(ship, executor)), buff, bp);
    break;
  case 's': /* status */
    if (is_dbref(args[1]))
      n = dbref2sdb(parse_dbref(args[1]));
    ...
    switch (parse_integer(args[2])) {
    case 1:
      safe_str(unparse_integer(do_sensor_contacts(args[3], enactor)), buff, bp);
      break;
    case 2:
      safe_str(unparse_integer(do_eng_status(enactor)), buff, bp);
      break;
    case 3:
      safe_str(unparse_integer(do_helm_status(enactor)), buff, bp);
      break;
    case 4:
      safe_str(unparse_integer(do_tactical_status(enactor)), buff, bp);
      break;
    case 5:
      safe_str(unparse_integer(do_beam_status(enactor)), buff, bp);
      break;
    case 6:
      safe_str(unparse_integer(do_missile_status(enactor)), buff, bp);
      break;
    case 7:
      safe_str(unparse_integer(do_operations_status(enactor)), buff, bp);
      break;
    case 8:
      safe_str(
        unparse_integer(do_sensor_report(parse_integer(args[3]), enactor)),
        buff, bp);
      break;
    case 9:
      safe_str(unparse_integer(do_allocation_status(enactor)), buff, bp);
      break;
    case 10:
      safe_str(unparse_integer(
                 do_damage_status(parse_integer(args[3]), args[4], enactor)),
               buff, bp);
      break;
    case 11:
      safe_str(unparse_integer(do_science_status(enactor)), buff, bp);
      break;
    case 12:
      safe_str(unparse_integer(do_fighter_status(enactor)), buff, bp);
      break;
    case 13:
      safe_str(unparse_integer(
                 do_scanner_report(parse_integer(args[3]), args[4], enactor)),
               buff, bp);
      break;
    case 14:
      safe_str(unparse_integer(do_nebula_report(enactor)), buff, bp);
      break;
    case 15:
      safe_str(unparse_integer(do_border_report(enactor)), buff, bp);
      break;
    case 16:
      safe_str(unparse_integer(do_planet_report(args[3], 1, enactor)), buff,
               bp);
      break;
    case 17:
      safe_str(unparse_integer(do_planet_report(args[3], 0, enactor)), buff,
               bp);
      break;
    case 18:
      do_sensor_contacts_bot(args[3], enactor, buff, bp);
      break;
    case 19:
      safe_str(unparse_integer(do_iff_check(parse_integer(args[3]))), buff, bp);
      break;
    case 20:
      safe_str(output_shields_raw(), buff, bp);
      break;
    default:
      safe_str("#-1 NO SUCH FIELD SELECTION", buff, bp);
      break;
  ...
  case 'v': /* variable */
    ...
    case 'c': /* cochrane */
      ...
      safe_str(unparse_number(cochrane), buff, bp);
      break;
    case 'n': /* console */
      console = parse_dbref(args[3]);
      if (!GoodObject(console)) {
        safe_str("#-1 NOT A VALID DBREF", buff, bp);
        return;
      }
      switch (args[2][0]) {
      ...
      safe_str(unparse_dbref(console), buff, bp);
      break;
    default:
      safe_str("#-1 NO SUCH FIELD SELECTION", buff, bp);
      break;
  ...
  case 'w': /* write */
    ...
    safe_str(unparse_integer(do_space_db_write(ship, executor)), buff, bp);
    break;
  default:
    safe_str("#-1 NO SUCH FIELD SELECTION", buff, bp);
    break;
                         ...
                         */
{
  ...
  if (!Wizard(Owner(executor))) {
      ...
      for (i = MIN_COMMS_OBJECTS; i <= MAX_COMMS_OBJECTS; ++i)
        if (cdb[i].object) {
          if (!GoodObject(cdb[i].object) || !Hasprivs(Owner(cdb[i].object))) {
            notify_format(executor, "#%d/%d: bad object deleted.",
                          cdb[i].object, i);
            cdb[i].object = 0;
            cdb[i].lower = 0.0;
            cdb[i].upper = 0.0;
            ...
            if (cdb[i].lower < MIN_COMMS_FREQUENCY) {
              notify_format(executor, "#%d/%d: bad lower bandpass fixed.",
                            cdb[i].object, i);
              cdb[i].lower = MIN_COMMS_FREQUENCY;
            }
            if (cdb[i].upper > MAX_COMMS_FREQUENCY) {
              notify_format(executor, "#%d/%d: bad upper bandpass fixed.",
                            cdb[i].object, i);
              cdb[i].upper = MAX_COMMS_FREQUENCY;
            }
            if (cdb[i].upper < cdb[i].lower) {
              notify_format(executor, "#%d/%d: bad bandpass fixed.",
                            cdb[i].object, i);
    ...
    case 'l': /* list <void> */
      for (i = MIN_COMMS_OBJECTS; i <= max_comms_objects; ++i)
        if (cdb[i].object == executor) {
          safe_str(tprintf("#%d %d %f %f", cdb[i].object, i, cdb[i].lower,
                           cdb[i].upper),
                   buff, bp);
          return;
        }
      ...
      for (i = MIN_COMMS_OBJECTS; i <= max_comms_objects; ++i)
        if (cdb[i].object == executor) {
          ...
          notify_format(executor,
                        "#%d/%d: bandpass set to %f (lower) and %f (upper).",
                        cdb[i].object, i, cdb[i].lower, cdb[i].upper);
          return;
        }
      safe_str("#-1 OBJECT NOT IN CDB", buff, bp);
      break;
      ...
      for (i = MIN_COMMS_OBJECTS; i <= max_comms_objects; ++i) {
        ...
        if (cdb[i].object) {
          ...
          if (!fetch_ufun_attrib(
                tprintf("#%d/%s", cdb[i].object, EXECUTE_ATTR_NAME), executor,
                &ufun, (UFUN_OBJECT | UFUN_REQUIRE_ATTR | UFUN_IGNORE_PERMS)))
            continue;
          ...
          if (e) {
            ...
            if (a == NULL) {
              ...
              pe_regs_setenv(pe_regs, 9,
                             space_crypt_code(atr_value(a), msg, 0));
            }
          } else {
            pe_regs_setenv(pe_regs, 9, msg);
          }
...
FUNCTION(local_fun_ly2pc)
{
  if (!is_number(args[0])) {
    ...
    safe_str(unparse_number(parse_number(args[0]) * LIGHTYEAR / PARSEC), buff,
             bp);
  return;
}
...
FUNCTION(local_fun_pc2ly)
{
  if (!is_number(args[0])) {
    ...
    safe_str(unparse_number(parse_number(args[0]) * PARSEC / LIGHTYEAR), buff,
             bp);
  return;
}
...
FUNCTION(local_fun_secs2sd)
{
  if (!is_integer(args[0])) {
    ...
    safe_str(unparse_number(((parse_integer(args[0]) - 558964800) / 31557.6) +
                            61153.7),
             buff, bp);
  return;
}
...
FUNCTION(local_fun_sd2secs)
{
  ...
  if (!is_number(args[0])) {
    ...
    if (sd > 80000.0) {
      ...
      safe_str(unparse_integer((int) ((sd - 61153.7) * 31557.6) + 558964800),
               buff, bp);
  }
  return;
}
/* Re-written for efficiency. You can now pass a dbref to it, and it'l return
*the dbref if it's a real space object.
** -Qon 08/30/2014
*/
...
/* ------------------------------------------------------------------------ */
// Jarek recoded along with lookup_space to return nice lists of possible
// matches
/* ARGSUSED */
/* Replaced.
FUNCTION(local_fun_spacenum)
...
FUNCTION(local_fun_coords)
{
  ...
  if (Hasprivs(executor) || has_power_by_name(executor, "SDB-OK", NOTYPE) ||
      has_power_by_name(executor, "SDB-READ", NOTYPE)) {
    ...
    if (!GoodSDB(sdb_num))
      ...
      if (c_type)
        safe_str(tprintf("%f %f %f", sdb[sdb_num].coords.x / PARSEC,
                         sdb[sdb_num].coords.y / PARSEC,
                         sdb[sdb_num].coords.z / PARSEC),
                 buff, bp);
      else
        safe_str(tprintf("%f %f %f", sdb[sdb_num].coords.x,
                         sdb[sdb_num].coords.y, sdb[sdb_num].coords.z),
                 buff, bp);
    }
  } else
    safe_str("#-1 PERMISSION DENIED", buff, bp);
              ...
              if (the_range <= q && relay != NULL) {
                if (args[4] != NULL) {
                  if (parse_number(relay) == parse_number(args[4])) {
                    safe_format(buff, bp, "#%d|%d|%f", sdb[i].object, i,
                                sdb2range(n, i));
                    safe_str(" ", buff, bp);
                  }
                } else {
...
FUNCTION(local_fun_border)
{
  ...
  case 'a':
    if (nargs != 7) {
      safe_format(buff, bp, "#-1 INVALID NUMBER OF ARGUMENTS %d. REQUIRES 6",
                  nargs);
      return;
    }
    addNewBorder(executor, parse_integer(args[1]), args[2],
                 parse_integer(args[3]), parse_number(args[4]),
                 parse_number(args[5]), parse_number(args[6]),
                 parse_number(args[7]), buff, bp);
    break;
  case 'd':
    if (nargs != 1) {
      safe_format(buff, bp, "#-1 INVALID NUMBER OF ARGUMENTS %d. REQUIRES 1",
                  nargs);
      return;
    }
  ...
  case 'e':
    if (nargs != 3) {
      safe_format(buff, bp, "#-1 INVALID NUMBER OF ARGUMENTS %d. REQUIRES 3",
                  nargs);
      return;
    }
...
void
console_notify_all(int x, char *msg)
{
  ATTR *a, *b;
...
void
console_notify(int x, char *msg, int numargs, char **args)
{
  ATTR *a, *b;
  ...
  if (a && *AL_STR(a)) { // Attribute exists AND isn't empty
    ...
    write_spacelog(
      GOD, sdb[x].object,
      tprintf("CONSOLE_NOTIFY: Missing or Empty %s ATTRIBUTE on #%d (%d)",
              CONSOLE_ATTR_NAME, sdb[x].object, x));
    return;
  }
}
...
void
console_message(int x, char *consoles, char *msg)
{
...
FUNCTION(local_fun_consolenotify)
{
  ...
  if (!GoodObject(sdb[x].object) || !SpaceObj(sdb[x].object)) {
    write_spacelog(sdb[x].object, sdb[x].object,
                   "BUG: invalid zone to zemit to.");
    return;
  }
