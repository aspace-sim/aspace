...
int db_read_allocate (dbref ship, dbref executor)
{	
...
int db_read_beam (dbref ship, dbref executor)
{
...
int db_read_beam_active (dbref ship, dbref executor)
{
	if (sdb[x].beam.exist) {
...
int db_read_beam_name (dbref ship, dbref executor)
{
	if (sdb[x].beam.exist) {
...
int db_read_beam_damage (dbref ship, dbref executor)
{
	if (sdb[x].beam.exist) {
...
/* ALLOCATE */ result = db_read_allocate (ship, executor);
/* BEAM */ result = db_read_beam (ship, executor);
/* BEAM_ACTIVE */ result = db_read_beam_active (ship, executor);
/* BEAM_NAME */	result = db_read_beam_name (ship, executor);
/* BEAM_DAMAGE */ result = db_read_beam_damage (ship, executor);
